...
<main>
  <section>
    <dl>
      ...
      <dd>So many RSS feeds that you have to scroll to see them all.</dd>
      ...
      <dd>Three or more distinct SPAs mashed together to appear as one to the end user.</dd>
